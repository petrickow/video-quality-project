...
public class StaXParserForXML {
	...
	/*
	  public List<XMLCreator> readXMLData(){
		StaXParserForXML read = new StaXParserForXML();
		List<XMLCreator> readConfig = read.readXML("src/main/resources/testXML/test1.xml");
			for (XMLCreator item : readConfig) {
